...
export default async function LayoutSite({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <a
        href="#conteudo"
        className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[60] focus:rounded-[var(--raio-mini)] focus:bg-tinta focus:px-4 focus:py-3 focus:text-parede"
      >
        Ir para o conteúdo
      </a>
